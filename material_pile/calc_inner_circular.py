...
class Page1:
    ...
    def show_concentric_spheres(self):
        ...
        r2 = float(self.entries["B半径(内)"].get())
        ...
        # 更新半径
        self.entries["B半径(内)"].delete(0, tk.END)
        self.entries["B半径(内)"].insert(0, r2)
    ...
    def calculate_and_display(self):
        ...
        # 判断小球半径的2倍是否大于盒子大小
            ...
            if diameter2 > diameter1:
                raise ValueError("Abnormal small ball radius: The diameter of the ball B is larger than the size of the big ball")

            if diameter3 > diameter2:
                raise ValueError("Abnormal small ball radius: The diameter of the ball C is larger than the size of the big ball")

            if diameter1 < diameter2 + diameter3:
                raise ValueError("Abnormal small ball radius: The diameter of the ball A&B is larger than the size of the big ball")
        ...
        # 计算每类材料的质量
        mass_A = num_A * (4 / 3) * np.pi * (r1 ** 3 - r2 ** 3 - r3 ** 3) * A_density
...
def main():
    root = tk.Tk()
    root.title("circular_inner_ball")
